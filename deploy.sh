...
PM_FILE="Koha/Plugin/Fi/KohaSuomi/ValidateMobileUncheckMessageTransports.pm"
...
if [ "$CURRENT_BRANCH" == "master" ]; then
    ...
    RELEASE_FILE="koha-plugin-intranetjs-validate-mobile-uncheck-message-transports-v${VERSION}.kpz"
else
